...
class OffTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create off_time' do
    assert_difference('OffTime.count') do
      post off_times_url,
           params: { off_time: { ends_at: @off_time.ends_at, starts_at: @off_time.starts_at, user_id: @off_time.user_id,
                                 vacation_id: @off_time.vacation_id } }
    end
