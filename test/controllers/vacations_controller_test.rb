...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference("Vacation.count") do
      post vacations_url, params: { vacation: { balance: @vacation.balance, expires_at: @vacation.expires_at, user_id: @vacation.user_id, year: @vacation.year } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { balance: @vacation.balance, expires_at: @vacation.expires_at, user_id: @vacation.user_id, year: @vacation.year } }
